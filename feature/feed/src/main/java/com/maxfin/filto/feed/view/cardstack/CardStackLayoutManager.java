package com.maxfin.filto.feed.view.cardstack;
...
import com.maxfin.filto.feed.R;
import com.maxfin.filto.feed.view.cardstack.internal.CardStackSetting;
import com.maxfin.filto.feed.view.cardstack.internal.CardStackSmoothScroller;
import com.maxfin.filto.feed.view.cardstack.internal.CardStackState;
import com.maxfin.filto.feed.view.cardstack.internal.DisplayUtil;
...
public class CardStackLayoutManager
    ...
    private void update(RecyclerView.Recycler recycler) {
        ...
        if (state.isSwipeCompleted()) {
             ...
             *
             * 2019-03-31 18:44:29.744 8496-8496/com.maxfin.cardstackview.sample E/AndroidRuntime: FATAL EXCEPTION: main
             *     Process: com.maxfin.cardstackview.sample, PID: 8496
             *     java.lang.IllegalStateException: Cannot call this method while RecyclerView is computing a layout or scrolling com.maxfin.cardstackview.CardStackView{9d8ff78 VFED..... .F....ID 0,0-1080,1353 #7f080027 app:id/card_stack_view}, adapter:com.maxfin.cardstackview.sample.CardStackAdapter@e0b8651, layout:com.maxfin.cardstackview.CardStackLayoutManager@17b0eb6, context:com.maxfin.cardstackview.sample.MainActivity@fe550ca
             ...
             *         at com.maxfin.cardstackview.sample.MainActivity.paginate(MainActivity.kt:164)
             *         at com.maxfin.cardstackview.sample.MainActivity.onCardSwiped(MainActivity.kt:50)
             *         at com.maxfin.cardstackview.CardStackLayoutManager.update(CardStackLayoutManager.java:277)
             *         at com.maxfin.cardstackview.CardStackLayoutManager.scrollHorizontallyBy(CardStackLayoutManager.java:92)
